...
**Промежуточные итоги N/7:** день засчитан, если отмечена практика из расписания **или** в тот же календарный день нажали «Я сделал» на другой практике бота («Ещё практики»). При нажатии на замену автоматически отмечается и сегодняшняя практика челленджа; если сегодняшняя ещё не приходила — вчерашняя незакрытая.
...
| 8, 15, 22 (понедельники) | Промежуточный прогресс за неделю (N/7 дней) + «Вы прекрасны! Продолжайте!» |
...
- `/favorite` - личный список избранных практик: сохраняй понравившиеся кнопкой «🧡 В избранное» под практикой и открывай нужную из меню.
