...
| Ввод времени в онбординге (1-е) | Пользователь выбрал Daily/Challenge, но не ввёл время | Через **4 часа** после запроса времени | `Мы уже почти готовы начать долгий и счастливый путь к движению, осталось выбрать время, когда хочешь получать сообщения\n\n*Введи время в формате ЧЧ.ММ (например, 09.30)*` |
