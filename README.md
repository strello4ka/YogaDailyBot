...
**Промежуточные итоги (дни 8, 15, 22):** N/M — выполнено **M** практик из **M** прошедших дней челленджа (на 15-й день: «7/15 дней»). Засчёт дня — как в ежедневной сводке (расписание или замена через «Ещё практики»).
...
| 8, 15, 22 (понедельники) | Промежуточный прогресс за весь челлендж на сегодня (N/M дней) + «Вы прекрасны! Продолжайте!» |
