...
def build_challenge_finished_text(completed: Optional[int] = None) -> str:
    """Совместимое имя; все тексты финала находятся в post_challenge.py."""
    from app.challenge.flow.post_challenge import finished_text
    return finished_text(completed)
