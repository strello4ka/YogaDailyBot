...
async def help_command(update: Update, context):
    ...
    help_text = (
        ...
        "Если хочешь сообщить об ошибке, предложить идею или просто общаться с другими пользователями бота, то заходи в [группу] (https://t.me/+ammNnozkY9kyNTJi) или пиши @strello4ka. Благодаря тебе YogaDailyBot станет лучше!"
    )
