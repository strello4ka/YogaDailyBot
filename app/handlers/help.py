...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    help_text = (
        ...
        "Но постарайся не выполнять за 1-2 часа до сна практики средней и высокой интенсивности.\n"
        "Практики низкой интенсивности можно делать прямо перед сном.\n\n"
        "🌀 *2. Мне нужен VPN?*\n"
        ...
        "🌀 *5. Как сохранить понравившуюся практику?*\n"
        "Нажми *🧡 В избранное* под практикой или открой раздел *🧡 Избранное* в меню — там будут все твои любимки.\n\n"
        "🌀 *6. Куда задавать вопросы?*\n"
...
HELP_SLEEP_QUESTION_MARKDOWN = (
    ...
    "_Маркер для таких практик в боте: интенсивность — низкая._"
)
